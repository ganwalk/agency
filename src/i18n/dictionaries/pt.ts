// Fonte da verdade. Dictionary é derivado deste arquivo: o TypeScript aponta
...
export const pt = {
  ...
  legal: {
      ...
      sections: [
        {
          ...
          body: "Coletamos os dados que você nos envia voluntariamente pelo formulário de contato (nome, empresa, email e mensagem), além de dados de navegação básicos para entender o uso do site.",
        },
        {
        ...
        },
        {
          ...
          body: "Você pode solicitar a qualquer momento a confirmação, o acesso, a correção ou a exclusão dos seus dados pessoais, entrando em contato pelo email informado no rodapé deste site.",
        },
        {
    ...
    terms: {
      title: "Termos de Uso",
      updated: "Última atualização",
      intro: "Ao acessar este site, você concorda com os termos descritos abaixo.",
      sections: [
        {
          heading: "Objeto",
        ...
        {
          heading: "Uso do site",
          body: "O conteúdo deste site é informativo. O envio do formulário de contato não gera, por si só, nenhuma obrigação contratual entre as partes, que só existe após proposta formal aceita por escrito.",
        },
        {
...
// typeof pt sozinho travaria os outros idiomas nos literais exatos do
// português (com `as const`, cada string vira o próprio tipo literal).
// DeepStringify mantém o formato do dicionário, mas relaxa toda folha de
// texto para `string`, então TypeScript ainda aponta chave faltando ou
// campo errado, só não exige o mesmo texto.
